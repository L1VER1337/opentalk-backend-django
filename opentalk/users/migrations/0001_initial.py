    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('online', 'Онлайн'), ('offline', 'Офлайн'), ('dnd', 'Не беспокоить')], default='offline', max_length=20, verbose_name='Статус')),
                ...
                ('theme_preference', models.CharField(choices=[('light', 'Светлая'), ('dark', 'Темная')], default='light', max_length=10, verbose_name='Тема оформления')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('followed', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='followers', to=settings.AUTH_USER_MODEL, verbose_name='Подписка')),
